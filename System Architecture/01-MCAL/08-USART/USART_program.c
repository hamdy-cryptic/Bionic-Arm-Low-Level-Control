	 ...
	 void  USART_SEND_CHAR(u8 character)
{
	    ...
	    CLR_BIT(USART1 -> CR1 ,3);  //Clear Transmit Enable
	    CLR_BIT(USART1 -> CR1 ,13);  //Clear UART Enable
		  USART1 -> DR = character ;
	    SET_BIT(USART1 -> CR1 ,3);   //Set Transmit Enable
	    SET_BIT(USART1 -> CR1 ,13);  //Set UART Enable
