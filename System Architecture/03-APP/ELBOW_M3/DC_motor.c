...
{ 
	...
	// VNH5019_M1INA == DC_PB4
		 
			 // Digital output
			 GPIO_voidSetPinDirection(GPIOB , 4 , GPIO_OUTPUT );
			 GPIO_SET_PP_OD (GPIOB , 4, GPIO_OUTPUT_PP); 
			 SET_GPIO_SPEED( GPIOB,4,  GPIO_SPEED_LOW );
    ...
    // VNH5019_M1EN == DC_PB3
			  ...
			  //Digital input
			  GPIO_voidSetPinDirection(GPIOB , 3 , GPIO_OUTPUT );
			  SET_GPIO_SPEED( GPIOB,3, GPIO_SPEED_LOW );
			  GPIO_SET_PP_OD (GPIOB , 3, GPIO_OUTPUT_PP); 
				GPIO_voidSetPinValue(GPIOB,3,GPIO_HIGH);
			  
	// VNH5019_M1PWM == DC_PB6 
...
{   
    ...
    switch(motor)
	{   // VNH5019_M1PWM == DC_PC7 
		case M1 :  PWM_PinWrite(PWM_PB6, speed, Period);
		           break;
	    // VNH5019_M2PWM == DC_PB6
...
{   
    if(direction==Direction_CW)
	{
      switch(motor)
	    {  // VNH5019_M1INA == DC_PA10 --> high  &  VNH5019_M1INB == DC_PB5 --> low
		    case M1 :  GPIO_voidSetPinValue(GPIOB , 4 , GPIO_HIGH); 
	...
	{  
	    ...
	    {    // VNH5019_M1INA == DC_PA10 --> low  &  VNH5019_M1INB == DC_PB5 --> high
		    case M1 : GPIO_voidSetPinValue(GPIOB , 4 , GPIO_LOW); 
...
{   
    ...
    switch(direction)
		...
		case Direction_CW   : PWM_PinWrite(IB_pin, 1, Period); PWM_PinWrite(IA_pin, speed, Period);           break;
		                      
		case Direction_CCW  : PWM_PinWrite(IA_pin, 1, Period); PWM_PinWrite(IB_pin, speed, Period);           break;
