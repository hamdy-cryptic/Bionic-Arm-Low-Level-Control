...
// RCC config 
 RCC_voidEnableClock (RCC_APB2 , RCC_ADC1 );                                                 //enable clock to ADC	
	switch  (Copy_u8GPIO_Port){                                                                //enablw port clock
		case POT_GPIOA: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOA ); break;
		case POT_GPIOB: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOB ); break;
		case POT_GPIOC: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOC ); break;
		case POT_GPIOD: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOD ); break;
		case POT_GPIOE: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOE ); break;
		case POT_GPIOF: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOF ); break;
		case POT_GPIOG: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOG ); break;
		case POT_GPIOH: RCC_voidEnableClock (RCC_AHB1 , RCC_GPIOH ); break;
	}
