...
/* If you want a certain USART, Remove (//) of the comment to active it */
   ...
   /* clock of APB2 for USART1 */
  #define   fck2     72000000UL
  /* clock of APB1 for USART2,3,4,5 */
  #define   fck1      72000000UL   
  ...
  #define   USART_DMA_TX           DMAT_DISABLE                              // Not available for UART5
  #define   USART_DMA_RX           DMAR_ENABLE                            // Not available for UART5
