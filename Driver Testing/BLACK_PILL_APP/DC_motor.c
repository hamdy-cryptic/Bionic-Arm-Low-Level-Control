...
{   
    ...
    switch(direction)
		...
		case Direction_CW   : PWM_PinWrite(IB_pin, 0, Period); PWM_PinWrite(IA_pin, speed, Period);           break;
		                      
		case Direction_CCW  : PWM_PinWrite(IA_pin, 0, Period); PWM_PinWrite(IB_pin, speed, Period);           break;
